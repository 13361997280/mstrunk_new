                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a href="../authoritiesgroup/add.do">新增</a>
                            </div>
                        </div>
                            ...
                            <table class="table">
                                ...
                                <c:forEach items="${list}" var="item">
                                    <tr>
                                        <td>${item.id}</td>
                                        <td>${item.name}</td>
                                        <td>${item.resouceNames}</td>
                                        <td><a href="../authoritiesgroup/edit.do?id=${item.id}">编辑</a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            <a href="../authoritiesgroup/del.do?id=${item.id}">删除</a></td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
