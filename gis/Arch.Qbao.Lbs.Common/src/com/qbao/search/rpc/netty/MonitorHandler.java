 ...
 */
public class MonitorHandler extends SimpleHttpRequestHandler<String> {
	...
	protected String doRun() throws Exception {
		return server.getMonitorInfos(
			CommonUtil.getBooleanParam(httpRequest, "forAlerting"),
			CommonUtil.getParam(httpRequest, "keyPattern"),
			CommonUtil.getParam(httpRequest, "responseFormat"),
			CommonUtil.getParam(httpRequest, "sep")
		);
	}
