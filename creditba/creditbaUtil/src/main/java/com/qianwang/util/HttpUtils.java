...
public class HttpUtils {
    ...
    public static HttpResult getData(String url) throws IOException {
    	log.info("GET请求:"+url);
    ...
    public static HttpResult postData(String url, byte[] postData) throws Exception{
    	log.info("POST请求:"+url);
    	HttpURLConnection conn = null;
    	try {
			conn = getURLConnection(url);
    ...
    private static HttpURLConnection getURLConnection(String urlStr) throws IOException{
    ...
    private static byte[] readBody(HttpURLConnection conn) throws IOException{
		...
		byte[] body = IOUtils.toByteArray(input);
		return body;
    }
    
	private static HttpResult getHttpResult(HttpURLConnection conn) throws IOException{
