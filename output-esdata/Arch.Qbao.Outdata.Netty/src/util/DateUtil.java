...
public class DateUtil {
	...
	public static Date LongToDate(Long dateLong) throws ParseException {
		//前面的lSysTime是秒数，先乘1000得到毫秒数，再转为java.util.Date类型
		java.util.Date dt = new Date(dateLong);  
		return dt;
	}
	
	public static String LongToString(Long dateLong) throws ParseException {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		//前面的lSysTime是秒数，先乘1000得到毫秒数，再转为java.util.Date类型
		java.util.Date dt = new Date(dateLong);  
	...
	public static void main(String args[]) throws ParseException {
		 ...
		 * accurateToDay(new Date()); Date date2 = accurateToDay(sdf.parse(
		 * "2013-01-07 12:12:12")); System.out.println(sdf.format(date1) + "   "
		 * + sdf.format(date2)); System.out.println(date1.compareTo(date2) ==
		 * 0); System.out.println(endDate.getTime()); Date md = sdf.parse(
		 * "2013-05-21 13:01:47"); System.out.println(new Date().getTime());
		 * System.out.println("====================="); Date dateAtMin =
		 * DateUtil.DayFloorMin(new Date()); String fromDate =
		 ...
		 */
		long a = 1503369809753l;
		System.out.println(DateUtil.LongToString(a));
